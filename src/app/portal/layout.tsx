...
function PortalContent({
  ...
  return (
    <div className="flex min-h-screen bg-surface font-body">
      ...
      {/* Bottom Nav (Mobile Only) - Optional, keeping for consistency with dashboard mobile feel if preferred, 
          but usually Sidebars handles this on mobile via hamburger. 
          The dashboard doesn't have a bottom nav, so I'll remove it for pure structural unification. */}
    </div>
  )
}
